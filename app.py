...
if st.button("Analyze Market"):
    try:
        ...
        if not daily_data.empty and not intraday_data.empty:
            ...
            daily_data['EMA_200'] = calculate_ema(daily_data['Close'], 200)
            intraday_data['RSI'] = calculate_rsi(intraday_data['Close'], 14)
            intraday_data['MACD'] = calculate_macd(intraday_data['Close'], 12, 26, 9)
